...
<section class="hero">
  ...
  <div class="hero-text white text-center">
    ...
    <p class="light-grey">
      Whether you`re moving for work, retirement, or just a change of scenery,
      this ebook is packed with practical advice and insider tips to help you
      navigate the process with ease.
    </p>
    <Button onclick={() => alert('Button clicked!')}>Purchase E-book for 10$</Button>
    {/if}
  </div>
</section>
